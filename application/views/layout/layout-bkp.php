...
<html>
                ...
                <div class="row">
                    <div class="col-10">
                        <ul class="t_menu">
                            ...
                            <li><a href="<?php echo base_url('errorpo'); ?>" class="<?php echo isset($menu_id) && ($menu_id == 'error') ? "active" : ""; ?>">errors</a></li>
                                <?php
                            if (isUserLogin()) {
    ...
    <?php } ?>
                                <li class="sub"><span><?php echo $userLoginData['user_name'] ?></span>
                                    <ul class="sub_menu">
...
<?php $this->load->view($view_file); ?>
        ...
        ?>
                <div class="loader_amd"><div class="loading-img">Processing ...<img src="<?php echo site_url("assets/images/808.gif")?>" alt=""></div></div>
                <style>
                    .loader_amd { position: fixed; background: #000; width: 100%; height: 100%; top: 0; z-index: 1000; display: none; opacity: 0.9; color: #fff;}
                    .loading-img{ position: absolute; top: 50%; left:50%; transform: translate(-50%, -50%); -webkit-transform: translate(-50%, -50%); -moz-transform: translate(-50%, -50%); width: 100px;}

...
<div class="content">
	<div class="wraper">
		...
		<div class="form-box">
        	<h1 class="heading-1"><?php echo (isset($page_title) ? $page_title : 'forgot password'); ?></h1> 
        	...
        	<div class="form-box-block">
                ...
                <input id="email" class="st_box" placeholder="email" name="email" type="text">
                <?php  echo form_error('email', '<span class="in_danger">', '</span>'); ?>
            </div>
            <div class="form-box-block form-btn-block row">
            	<div class="col-6">
                	<a href="<?php echo base_url("user/login"); ?>">Go to Login</a>
                </div>
                <div class="col-6 tar">
                	<span class="btn_small"><input value="SEND" type="submit"  name="forget_submit" ></span>
                </div>
            </div>                        
...
<div class="form login_bg">
    <?php if (validation_errors() || $this->session->flashdata('error_message')) { ?>
        <div class="row">
            <div class="alert-danger"><?php
                ...
                ?><span class="a_close"><i aria-hidden="true" class="fa fa-close"></i></span></div>
        </div>                    
    <?php } ?>
    <?php if ($this->session->flashdata('success_message')) { ?>
        <div class="row">
    ...
    <div class="form-group">
        ...
        <input type="text" name="email" value="" id="email" class="tbox" autocomplete="off" placeholder="Email"  />
        <?php ?>
    </div>                        
    <div class="row no_pad">
        <div class="col-8 no_pad"><a href="<?php echo site_url("user/login"); ?>">Login</a></div>
        <div class="col-4 no_pad tar">
            <input type="submit" name="forget_submit" value="Submit" id="loginsub" class="btn_small bg_blue"  />
        </div>
    </div>            
</div>
<?php echo form_close();  */ ?>